...
.DATA
    ...
    CurrentBlock            dW        0                                             ; the counter when it equel to RoadNum stop generat another number
...
GeneratRandomNumber endp
    ;***********************************************************************
    ;generate a track go make 1-start video mode 2-random value then 3-go to one direction
